...
# define COMPAT_COMPILER_IS_TinyCC 0
# define COMPAT_COMPILER_IS_Bruce 0
...
# define COMPAT_COMPILER_IS_SDCC 0
...
# undef COMPAT_COMPILER_IS_TinyCC
# define COMPAT_COMPILER_IS_TinyCC 1

#elif defined(__BCC__)
# undef COMPAT_COMPILER_IS_Bruce
# define COMPAT_COMPILER_IS_Bruce 1
...
# undef COMPAT_COMPILER_IS_SDCC
# define COMPAT_COMPILER_IS_SDCC 1
...
#      define COMPAT_COMPILER_C_FUNCTION_PROTOTYPES 1
#    else
#      define COMPAT_COMPILER_C_FUNCTION_PROTOTYPES 0
#    endif

#    if ((__clang_major__ * 100) + __clang_minor__) >= 400 && defined(__STDC_VERSION__) && __STDC_VERSION__ >= 199901L
#      define COMPAT_COMPILER_C_RESTRICT 1
#    else
#      define COMPAT_COMPILER_C_RESTRICT 0
#    endif

#    if ((__clang_major__ * 100) + __clang_minor__) >= 400 && defined(__STDC_VERSION__) && __STDC_VERSION__ >= 201112L
#      define COMPAT_COMPILER_C_STATIC_ASSERT 1
#    else
#      define COMPAT_COMPILER_C_STATIC_ASSERT 0
#    endif

#    if ((__clang_major__ * 100) + __clang_minor__) >= 400 && defined(__STDC_VERSION__) && __STDC_VERSION__ >= 199901L
#      define COMPAT_COMPILER_C_VARIADIC_MACROS 1
#    else
#      define COMPAT_COMPILER_C_VARIADIC_MACROS 0
#    endif
...
# if __SUNPRO_C >= 0x5100
   /* __SUNPRO_C = 0xVRRP */
#  define COMPAT_COMPILER_VERSION_MAJOR COMPAT_HEX(__SUNPRO_C>>12)
#  define COMPAT_COMPILER_VERSION_MINOR COMPAT_HEX(__SUNPRO_C>>4 & 0xFF)
#  define COMPAT_COMPILER_VERSION_PATCH COMPAT_HEX(__SUNPRO_C    & 0xF)
# else
   /* __SUNPRO_CC = 0xVRP */
#  define COMPAT_COMPILER_VERSION_MAJOR COMPAT_HEX(__SUNPRO_C>>8)
#  define COMPAT_COMPILER_VERSION_MINOR COMPAT_HEX(__SUNPRO_C>>4 & 0xF)
#  define COMPAT_COMPILER_VERSION_PATCH COMPAT_HEX(__SUNPRO_C    & 0xF)
# endif
...
#    if __SUNPRO_C >= 0x5130 && defined(__STDC_VERSION__) && __STDC_VERSION__ >= 199901L
#      define COMPAT_COMPILER_C_RESTRICT 1
#    else
#      define COMPAT_COMPILER_C_RESTRICT 0
#    endif

#    if __SUNPRO_C >= 0x5130 && defined(__STDC_VERSION__) && (__STDC_VERSION__ >= 201112L || __STDC_VERSION__ >= 199901L && defined(__C11FEATURES__))
#      define COMPAT_COMPILER_C_STATIC_ASSERT 1
#    else
#      define COMPAT_COMPILER_C_STATIC_ASSERT 0
#    endif
...
#  if defined(COMPAT_COMPILER_C_RESTRICT) && COMPAT_COMPILER_C_RESTRICT
